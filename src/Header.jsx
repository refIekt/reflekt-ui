    ...
    return (
      <header id="header">
        <div className="container">
          ...
          <svg id="logo" enableBackground="new 0 0 500 500" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
          ...
          <TypeSwitch types={this.props.types} switchType={this.props.switchType}/>
